<div class="column-1">
    ...
    <?php query_posts('category_name=middle-division-featured&showposts=4');?>
...
<div class="column-1">
    <div class="recent">
        <h1>Most Recent Middle Division Articles</h1>
    </div>
    <?php query_posts('showposts=5&category_name=middle-division');?>
    <?php while (have_posts()) : the_post(); ?>
        <div class="recent">
...
<div class="column-1">
    ...
    <?php query_posts('showposts=5&category_name=middle-divison&tag=School-News');?>
    <?php while (have_posts()) : the_post(); ?>
...
<div class="column-1">
    ...
    <?php query_posts('showposts=5&category_name=middle-division&tag=Governing-Council');?>
    <?php while (have_posts()) : the_post(); ?>
        <div class="featuredCategory">
            <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
            <p class="timestamp">Published on <?php the_time('l, F jS, Y g:i a') ?></p>
